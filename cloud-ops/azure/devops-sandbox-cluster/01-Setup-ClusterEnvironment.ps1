...
$newClusterInfo = New-ClusterByTerraform -ClusterName $clusterName -ClusterPath $commandPath -AgentCount 2 -VmSize 'Standard_DS2_v2' -ClusterLocation 'East US' -DiskSize 64
